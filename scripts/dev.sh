...
# command started an API with no AUTH_SECRET, which died at boot, and a worker
# whose REDIS_URL had been stripped, which then retried forever against the
# default :6379 while booking-redis listens on :6381.
#
